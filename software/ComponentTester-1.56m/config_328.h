...
/* source management */
#define CONFIG_328_H
/* Manuelle Definition f�r Port E (ATmega328PB), da der Compiler zu alt ist */
#ifndef PORTE
#define PIN_PORTE _SFR_MEM8(0x2C) /* Adresse des PINE Registers */
#define DDR_PORTE _SFR_MEM8(0x2D) /* Adresse des DDRE Registers */
#define OUT_PORTE _SFR_MEM8(0x2E) /* Adresse des PORTE Registers */

#define PINE  PIN_PORTE
#define DDRE  DDR_PORTE
#define PORTE OUT_PORTE
...
#define LCD_LINES         4   /* WICHTIG: Verhindert fr�hes Paging/Bl�ttern */
...
#define TestKey(t, m)     brutzelboy_get_key(t, m)
#define Encoder_Scan()    brutzelboy_get_encoder()

/*
 * Brutzelboy Handshake-Pins (Port C)
 */
#define BRUTZEL_PORT     PORTC
#define BRUTZEL_DDR      DDRC
#define BRUTZEL_PIN      PINC
#define BRUTZEL_WR       PC4    /* Ausgang: ATmega zeigt G�ltigkeit an */
#define BRUTZEL_RD       PC5    /* Eingang: ESP32 ACK / Sende-Wunsch */

#define BUTTON_PORT      PORTC
#define BUTTON_DDR       DDRC
#define BUTTON_PIN       PINC
#define TEST_BUTTON      PC3         /* Dein Knopf an PC3 */
/* --- Test Button Setup für PC3 --- */
#define TEST_KEY_PORT    PORTC    /* Port für die Pull-Up Steuerung */
#define TEST_KEY_DDR     DDRC     /* Datenrichtungsregister */
#define TEST_KEY_PIN     PINC     /* Register zum Einlesen des Zustands */
#define TEST_KEY         PC3      /* Die Bit-Position (Pin 3) */

/* --- Batterie-Messung --- */
/* Da kein Pin frei ist, messen wir die interne Referenzspannung */
#define TP_BAT          ADC_CHAN_BANDGAP
